...
package com.uzbrain.mame4droid.helpers;
...
import com.uzbrain.mame4droid.Emulator;
...
public class DialogHelper {
	...
	public Dialog createDialog(int id) {
	    ...
	    case DIALOG_FULLSCREEN:	
	    	...
	    	final CharSequence[] items2 = {"Help","Settings", "Netplay", "MotionRing"/*"Support"*/};	
	    	final CharSequence[] items3 = {"Exit","Load State", "Save State","Help","Settings", "Netplay"/*"Support",*/};	    	
	    	final CharSequence[] items4 = {"Exit","Help","Settings", "Netplay", "MotionRing" /*"Support"*/};	
